...
describe('AIChatBotFrontEndComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [AIChatBotFrontEndComponent, NoopAnimationsModule, FormsModule, ReactiveFormsModule, IGX_NAVBAR_DIRECTIVES, IgxIconButtonDirective, IgxIconComponent, IGX_LIST_DIRECTIVES, IGX_INPUT_GROUP_DIRECTIVES, IgxButtonDirective]
    })
    .compileComponents();
